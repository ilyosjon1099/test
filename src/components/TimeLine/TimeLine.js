  ...
  return (
    <Section id="about">
      ...
      <SectionText>
        ...
        ability to create visually appealing and responsive websites. I am a
        team player who thrives in collaborative environments and is dedicated
        to delivering projects on time and to the highest standard.
      </SectionText>
